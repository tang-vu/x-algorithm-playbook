...
□ Media adds value (if any)
□ Provides unique value
□ Matches my niche
□ No spam/banned keywords
□ 3+ hours since last post
□ Checked for typos

POST-PUBLISH:
□ Replied to comments first hour
□ Kept conversation going
```

---

**Next:** [Weekly Audit Checklist →](weekly-audit-checklist.md)
